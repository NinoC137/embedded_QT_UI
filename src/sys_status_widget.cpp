    ...
    : QWidget(parent)
{
    ...
    sys_cpuUsed->setStyleSheet("color:rgb(0, 0, 0); background: transparent; font-size: 12px;");

    sys_memUsed = new QLabel("Memory Used", this);
    sys_memUsed->setGeometry(45, 135, 130, 20);
    sys_memUsed->setAlignment(Qt::AlignCenter);
    sys_memUsed->setStyleSheet("color:rgb(0, 0, 0); background: transparent; font-size: 12px;");
